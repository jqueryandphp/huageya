...
const filterRootContainer = (html, functor) => {
  ...
  const root = ((_html$match = html.match(bodyExp)) === null || _html$match === void 0 ? void 0 : _html$match[1]) || '';
  const matchPublicPath = root.match(/<script.*src="([^"]*)\/?umi\.(\w+\.)?js"[^>]*>/i);
  const publicPath = (matchPublicPath === null || matchPublicPath === void 0 ? void 0 : matchPublicPath[1]) || '/';
  const context = {
    publicPath
  };
...
const nodePolyfillDecorator = (enable = false, origin = 'http://localhost') => {
  ...
  if (enable) {
    ...
    return (renderOpts, context = {
      ...
      if (polyfill === null || polyfill === void 0 ? void 0 : polyfill.host) {
      ...
      Object.defineProperty(global.window, 'location', {
        ...
        value: _objectSpread({
          ...
          origin: `${nextObj.protocol}//${nextObj.hostname}${(nextObj === null || nextObj === void 0 ? void 0 : nextObj.port) || ''}`
        }, nextObj)
      }); // @ts-ignore
